import { startCrawlForClassActivity } from './helpers/startCrawlForClassActivity';
...
export function handleClassActivityMessage(
  ...
  if (message.type === SIGNALS.CLASS_ACTIVITY_START_CRAWL) {
    ...
    startCrawlForClassActivity(message.dateRange, isCrawling, shouldStop).catch(console.error);
